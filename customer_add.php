...
function password_generate2($chars) 
{
  $dataa = '1234567890';
  return substr(str_shuffle($dataa), 0, $chars);
}
  
  $privatekey2=password_generate2(12)."\n";
...
?>
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                ...
                <input  name="cus_pwd" id='plainText' oninput="generateHash(this.value)" onchange="generateHash(this.value) size="30" type="password" required />
